...
configured station/action context, which arrival and same-place quiet phases
...
station. Version 1 route-history records remain valid; their station/action
records feed the same ranking without requiring phase metadata.
